...
class Mac80211MultiChannelPkt : public ::MacPkt
{
  ...
  public:
    ...
    virtual int getPktsToSend() const;
    virtual void setPktsToSend(int pktsToSend);
    virtual unsigned int getCubArraySize() const;
    virtual bool getCub(unsigned int k) const;
    virtual void setCub(unsigned int k, bool cub);
    virtual unsigned int getCabArraySize() const;
    virtual bool getCab(unsigned int k) const;
    virtual void setCab(unsigned int k, bool cab);
    virtual int getTransmissionAttempts() const;
    virtual void setTransmissionAttempts(int transmissionAttempts);
};
